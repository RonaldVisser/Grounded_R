...
Dat ziet er niet goed uit. Als je het csv-bestand opent in een tekst-editor, zoals Notepad/Kladblok of Notepad++ (<https://notepad-plus-plus.org/>{target="_blank"}) zul je zien dat de data bestaat uit teskt en dat de ; de verschillende velden scheidt (bijvoorbeeld: `1991-12-02;292`). 
